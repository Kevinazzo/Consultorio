...
//
//	//Region tab1Controls
//	EditText tab1_Paciente, tab1_Conyugue, tab1_Telefono, tab1_Email, tab1_Peso, tab1_Ref, tab1_Papa, tab1_Otro;
//	Spinner tab1_ECivil, tab1_TipoPaciente, tab1_Sexo;
//	TextView tab1_fechaNac;
//	Button tab1_SelectFecha;
//	//endregion
//
//	//Region tab2Controls
//	EditText tab2_Paciente, tab2_Email, tab2_RFC, tab3_Domicilio, tab2_Otro;
//	Button tab2_AgregarFactura;
//	//endregion
//
//	//Region tab3Controls
...
//
//	//Region tab4Controls
//	EditText tab4_Banco, tab4_NumTarjeta, tab4_Otro;
//	//endregion
//
//	//Region tab5Controls
//	EditText tab5_G, tab5_P, tab5_C, tab5_A, tab5_Otro;
//	TextView tab5_FUM;
//	Button tab5_SelectFUM;
//	//endregion
//
//
...
//
//		//endregion
//		edtNombre2 = (EditText) findViewById(R.id.Tab1_EditT_Paciente);
...
//
//			DatePickerDialog datePickerDialog = new DatePickerDialog(getCallingActivity(), new DatePickerDialog.OnDateSetListener() {
//				@Override
//				public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
//					lab(year + "-" + (month + 1) + "-" + dayOfMonth);
//				}
//			}, ano, mes, dia);
